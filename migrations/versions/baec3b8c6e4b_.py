...
Revision ID: baec3b8c6e4b
Revises: 
Create Date: 2024-09-03 00:53:20.252555
...
def upgrade():
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('order_status', sa.Enum('PENDING', 'ACCEPTED', 'SENDING', 'DONE', name='order_status'), nullable=False),
